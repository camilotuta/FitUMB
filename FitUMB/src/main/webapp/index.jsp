    ...
    <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li><a href="#features">Entrenamiento</a></li>
          <li><a href="#pricing">Alimentacion</a></li>
      ...
      <div class="container">
        <div class="row gy-4">
          ...
          <div class="col-lg-8 d-flex flex-column justify-content-center align-items text-center text-md-start" data-aos="fade-up">
            <h2>Bienvenido a FitUMB</h2>
            <p>Puedes descargar nuestra app en estas plataformas</p>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        <div class="row align-items-xl-center gy-5">
          ...
          <div class="col-xl-5 content">
            <h3>Tu salud es lo primero</h3>
            <h2>Te brindaremos acompa̱amiento en todo momento</h2>
            <p>Ipsa sint sit. Quis ducimus tempore dolores impedit et dolor cumque alias maxime. Enim reiciendis minus et rerum hic non. Dicta quas cum quia maiores iure. Quidem nulla qui assumenda incidunt voluptatem tempora deleniti soluta.</p>
            <a href="#" class="read-more"><span>Registrarme</span><i class="bi bi-arrow-right"></i></a>
          </div>
            ...
            <div class="row gy-4 icon-boxes">
              ...
              <div class="col-md-6" data-aos="fade-up" data-aos-delay="200">
                <div class="icon-box">
                  ...
                  <h3>Como afecta en donde vives</h3>
      ...
      <div class="container">
        ...
        <div class="row gy-4" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-md-4">
            <div class="card">
              <div class="img">
                <img src="assets/img/cards-4.jpg" alt="" class="img-fluid">
                <div class="icon"><i class="bi bi-hdd-stack"></i></div>
              </div>
              <h2 class="title">Tu mejor version</h2>
              <p>
          ...
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
            <div class="card">
              ...
              <h2 class="title">Siempre contigo</h2>
              <p>
          ...
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
            <div class="card">
              <div class="img">
                <img src="assets/img/cards-6.jpg" alt="" class="img-fluid">

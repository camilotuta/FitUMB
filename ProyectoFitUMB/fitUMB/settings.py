"""
Django settings for fitUMB project.
...
SECRET_KEY = 'django-insecure-ff)gb+)hfsuxpshm&qzy9_ia1zp@1n5@!0ig&81%cc^s)_0smv'
...
WSGI_APPLICATION = 'fitUMB.wsgi.application'
